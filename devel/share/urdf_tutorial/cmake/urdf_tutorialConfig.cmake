...
if("TRUE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /home/ROS_UCB/src/urdf_tutorial-master)
  set(urdf_tutorial_DEVEL_PREFIX /home/ROS_UCB/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /home/ROS_UCB/install)
...
if(NOT "/home/ROS_UCB/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'linux <jan.rosell@upc.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ROS_UCB/src/urdf_tutorial-master/${idir}'.  ${_report}")
    endif()
...
set(urdf_tutorial_EXPORTED_TARGETS "urdf_tutorial_generate_messages_cpp;urdf_tutorial_generate_messages_eus;urdf_tutorial_generate_messages_lisp;urdf_tutorial_generate_messages_nodejs;urdf_tutorial_generate_messages_py")
...
set(depends "tf2;tf2_ros;roscpp;rospy;std_msgs;message_runtime")
...
set(pkg_cfg_extras "urdf_tutorial-msg-extras.cmake")
